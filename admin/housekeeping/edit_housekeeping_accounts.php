...
<?php
	...
	{
		$query = "SELECT * FROM emp_accounts WHERE Emp_Acc_ID=".$_GET['edit_id'];
	...
	if ( isset($_POST['btn-update']))
	{
		...
		if (!$error)
		{
			$queries = "UPDATE emp_accounts SET Firstname = UPPER('$firstname'), Lastname = UPPER('$lastname'), Username = '$username', Password = '$userpass', Role = '$role'  WHERE Emp_Acc_ID =".$_GET['edit_id'];
	...
	{
		header("Location: housekeeping-accounts.php");
	}
...
?>
	...
	<script type="text/javascript">
		...
		function delete_id(Emp_Acc_ID)
		{
			...
			{
				window.location.href='edit_housekeeping_accounts.php?delete_id='+Emp_Acc_ID;
			}
		}
														...
														<form class="add-user" method="post" autocomplete="off">
															<fieldset>
																...
																<label class="block clearfix label-user">First Name
																	...
																	<input type="text" class="form-control" id="user_firstname" name="user_firstname" value="<?php echo $row['Firstname'] ?>" required/>
																...
																<label class="block clearfix label-user">Last Name
																	<span class="block input-icon input-icon-right">
																	<input type="text" class="form-control" id="user_lastname" name="user_lastname" value="<?php echo $row['Lastname'] ?>" required/>
