...
<?php 
    $query = "SELECT * FROM customer INNER JOIN concierge_request ON customer.Ref_N0. = concierge_request.Ref_No. WHERE Ref_No = (SELECT )"
?>



<!-- Modal -->
<div class="modal fade" id="conModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
