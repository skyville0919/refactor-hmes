...
$roleError="";
	...
	if ( isset($_POST['btn-save']))
	{
		...
		if (!$error)
		{
            $query = "INSERT INTO admin_accounts(Username, F_Name, L_Name, Password, Role, Code, date_created, Archived) VALUES ('$username', UPPER('$firstname'), UPPER('$lastname'), '$userpass', UPPER('$role'),'1', NOW(), '1')";
										...
										<div class="col-xs-12">
											<div class="row">
												...
												<div class="col-md-4">
													<div class="widget-box">	
														<div class="widget-header widget-header-flat adding-header">
															<i class="ace-icon fa fa-plus-square"></i> ADD ACCOUNT
														</div>
														...
														<form class="add-user" method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" autocomplete="off">
															<fieldset>
																...
																<label class="block clearfix label-user">Confirm Password
																	<span class="block input-icon input-icon-right">
																	<input type="password" class="form-control" id="confirm_password" name="confirm_password" onkeyup="validate();" required/>
												...
												<?php 
													...
													$query = "SELECT * FROM admin_accounts WHERE Code = '1'";
													$results = mysqli_query($db,$query);
																	...
																	?>
																		...
																		<tr class="smaller-font-1">
																			...
																			<td class="center">
																				...
																				<a href="javascript:delete_id('<?php echo $row['Acc_ID']; ?>')" class="btn btn-xs btn-danger bt-btn"><i class="ace-icon fa fa-trash bigger-120"></i>Disable</a>
