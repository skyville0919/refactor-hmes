...
<?php
	...
	{
		$query = "SELECT * FROM accounts WHERE Acc_ID=".$_GET['edit_id'];
	...
	if ( isset($_POST['btn-update']))
	{
		...
		if (!$error)
		{
			$queries = "UPDATE accounts SET Firstname = UPPER('$firstname'), Lastname = UPPER('$lastname'), Username = '$username', Password = '$userpass', Role = '$role'  WHERE Acc_ID =".$_GET['edit_id'];
