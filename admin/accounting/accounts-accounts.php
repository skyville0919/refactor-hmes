...
$roleError="";
	...
	if ( isset($_POST['btn-save']))
	{
		...
		if (!$error)
		{
            $query = "INSERT INTO accounts(Username, Firstname, Lastname, Password, Role, Code, date_created) VALUES ('$username', UPPER('$firstname'), UPPER('$lastname'), '$userpass', UPPER('$role'),'1', NOW())";
