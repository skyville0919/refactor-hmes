...
<!-- Modal -->
<div class="modal fade" id="restaurant-payment" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            ...
            <br/>
             ...
             <div class="row ml-4" id="tncCheck" hidden>
                <input type="checkbox" class="custm-checkbox" disabled>
                    <p class="termsP ml-4"> I have read and agreed to the <a class="termsLink" href="#tncModal3" data-toggle="modal" data-dismiss="modal">Terms & Conditions</a> <br/>and <a class="termsLink" data-toggle="modal" data-dismiss="modal" href="#pnpModal3">Privacy & Policy</a>.</p>
                </input>
            </div>
        </div>
        
      <div class="modal-footer" id="foot-restaurant">
        <button type="button" class="btn custm-modal-btn" data-toggle="modal" data-dismiss="modal" data-target="#summary-restaurant">Back</button>
