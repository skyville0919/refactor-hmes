...
<?php 
    if(isset($_SESSION['accounts']) != "") {
        $islogin = "<button type='button' class='btn btn-primary' data-toggle='modal' data-dismiss='modal' data-target='#reserve-modal' onclick='test()'>BOOK NOW</button>";
    } else {
...
<!-- Modal -->
<div class="modal fade custm-modal" id="studio-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header custm-header">
        <h5 class="custm-title" id="">STUDIO ROOM</h5>
        ...
        <div id="demo" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <?php 
                        $query = "SELECT * FROM slider WHERE room_type = 'STUDIO-ROOM'";
