...
<!-- Modal -->
<div class="modal fade" id="facility-payment" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <form id="offCard2">
            ...
            <div class="row ml-2" id="cashPayment">
                <label class="checkbox-container-payment label2">Cash Payment
                    <input type="radio" name="method" id="cash" onchange="handleChange2()"></input><span class="checkmark-payment"></span>
                </label>
            </div>   
            
            <div class="row ml-2" id="cardPayment">
                <label class="checkbox-container-payment label2">Card Payment
                    <input type="radio" name="method" id="card" onchange="handleChange2()"></input><span class="checkmark-payment"></span>
                </label>
            </div>  
            ...
            <div class="row ml-3" id="cardMethod" hidden>
                <div class="row">
                    <div class="col-md-12">
                        <input type="radio" class="custm-radio" id="off" name="radio1" onchange="master2()">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <input type="radio" class="custm-radio" id="on" name="radio1" onchange="master2()">
            ...
            <br/>
             ...
             <div class="row ml-4" id="tncCheck22" hidden>
                <input type="checkbox" class="custm-checkbox" disabled>
                    <p class="termsP ml-4"> I have read and agreed to the <a class="termsLink" href="#tncModal2" data-toggle="modal" data-dismiss="modal">Terms & Conditions</a> <br/>and <a class="termsLink" data-toggle="modal" data-dismiss="modal" href="#pnpModal2">Privacy & Policy</a>.</p>
                </input>
            </div>
      ...
      <div class="modal-footer" id="foot-facility">
        <button type="button" class="btn custm-modal-btn" data-toggle="modal" data-dismiss="modal" data-target="#summary-facility">Back</button>
