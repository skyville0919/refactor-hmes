...
<!-- Modal -->
<div class="modal fade" id="amenities-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="custm-title" id="">AMENITIES RESERVATION</h5>
                        ...
                        while($row=mysqli_fetch_array($result))
                            ?> 
                               <select name="res_type" id="res_type" class="custm-input form-control">
                                ...
                                <option value="ITALIAN STEAKHOUSE">HEEALTH AND WELLNESS GYM</option>
                               </select>
                            <?php
                    ?>
                </div>
